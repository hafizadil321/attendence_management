         ...
         <div class="col-lg-6">
            <div class="row">
               <div class="col-lg-6 w-100">
                  ...
                  <input type="text" class="form-control form-control-lg mb-4 mt-2 col-blue" name="lat" id="lat" placeholder="Enter Latitude">
                  <input type="text" class="form-control form-control-lg col-blue" name="lng" id="lng" placeholder="Enter Longitude">
               </div>
               <div class="col-lg-6 w-100">
                  <button type="button" class="btn btn-primary" onclick="SetMarker()">show location</button>
               </div>
               <div class="col-lg-6 w-100 mt-3">
                  ...
                  <div class="col-lg-12 w-100 mt-4">
                     <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="4" placeholder="Address">{{ old('address') }}</textarea>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-lg-6">
            <div class="select-all-chk" style="text-align: left;">
               ...
               <div class="form-check form-switch">
                  <input class="form-check-input main-check" type="checkbox" id="flexSwitchCheckDefault">
               </div>
            </div>
         </div>
         <div class="col-lg-6"></div> 
         <div class="col-lg-12 mt-4" id="online_event">
            <label class="form-label form-label-reset">Add link to your online event:</label>
            <input type="text" class="form-control form-control-lg" name="online_link" placeholder="Add Link To Your Online Event">
         </div>
...
<script type="text/javascript">
      ...
      var map;
        ...
        function SetMarker(position) {
            ...
            //sssconsole.log(lngi);
            if (lati == "") {
               lati = 31.438813429062925;
            }else{
               zoom = 25;
            }
            if (lngi == "") {
               lngi = 74.31283607579748;
            }
